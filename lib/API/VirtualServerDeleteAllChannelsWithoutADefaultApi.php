...
class VirtualServerDeleteAllChannelsWithoutADefaultApi extends ApiValidatorAbstract implements ApiInterface
{
    use ResponseTraits;
    ...
    function run(): void
    {
        ...
        TeamSpeakTemplateController::DeleteAllChannelWithoutADefault($server);

        $this->response('success', 'Все каналы за исключением стандартного удалены');
    }

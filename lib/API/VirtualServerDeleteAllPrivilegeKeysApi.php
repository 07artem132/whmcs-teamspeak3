...
class VirtualServerDeleteAllPrivilegeKeysApi extends ApiValidatorAbstract implements ApiInterface
{
    use ResponseTraits;
    ...
    function run(): void
    {
        ...
        TeamSpeakTemplateController::DeleteAllTokens($server);

        $this->response('success', 'Токены удалены');
    }

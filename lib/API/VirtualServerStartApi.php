...
class VirtualServerStartApi extends ApiValidatorAbstract implements ApiInterface
{
    use ResponseTraits;
    ...
    function run(): void
    {
        ...
        $this->response('success', 'Сервер был успешно запущен');
    }

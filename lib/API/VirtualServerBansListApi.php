...
use WHMCS\Module\Addon\TeamSpeak3\Traits\TeamSpeakStringToStringTraits;

class VirtualServerBansListApi extends ApiValidatorAbstract implements ApiInterface
{
    use ResponseTraits, TeamSpeakStringToStringTraits;
    ...
    function run(): void
    {
        ...
        $bans = $server->banList()->toArray();

        $this->TeamSpeakStringToString($bans);

        $this->responseData('success', $bans);
    }

...
class VirtualServerPrivilegeKeyDeleteApi extends ApiValidatorAbstract implements ApiInterface
{
    use ResponseTraits;
    ...
    function run(): void
    {
        ...
        $server->privilegeKeyDelete($_REQUEST['privilege_key']);

        $this->response('success', 'токен удален');
    }

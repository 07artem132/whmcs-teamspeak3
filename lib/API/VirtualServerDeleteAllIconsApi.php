...
class VirtualServerDeleteAllIconsApi extends ApiValidatorAbstract implements ApiInterface
{
    use ResponseTraits;
    ...
    function run(): void
    {
        ...
        TeamSpeakTemplateController::DeleteAllIcon($server);

        $this->response('success', 'Иконки удалены');
    }

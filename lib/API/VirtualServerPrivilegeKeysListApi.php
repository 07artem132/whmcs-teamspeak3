...
class VirtualServerPrivilegeKeysListApi extends ApiValidatorAbstract implements ApiInterface
{
    use ResponseTraits;
    ...
    function run(): void
    {
        ...
        $tokens = $server->privilegeKeyList(true);

        $this->responseData('success', $tokens->toArray());
    }

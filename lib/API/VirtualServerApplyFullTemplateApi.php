...
class VirtualServerApplyFullTemplateApi extends ApiValidatorAbstract implements ApiInterface
{
    use ResponseTraits;
    ...
    function run(): void
    {
        ...
        TeamSpeakTemplateController::ApplyFullTemplate($server, $_POST['template_id']);

        $this->response('success', 'группы и каналы шаблона применены');
    }

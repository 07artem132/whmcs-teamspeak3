...
class VirtualServerDeleteAllGroupsWithoutAGuestApi extends ApiValidatorAbstract implements ApiInterface
{
    use ResponseTraits;
    ...
    function run(): void
    {
        ...
        TeamSpeakTemplateController::DeleteAllGroupsWithoutAGuest($server);

        $this->response('success', 'Все группы за исключением гостевой удалены');
    }
